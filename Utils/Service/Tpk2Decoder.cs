    ...
    public static class Tpk2Decoder
    {
        ...
        public static BitmapSource[]? LoadAnimation(string filePath, int targetActionId = 0)
        {
            ...
            for (int i = 0; i < palCount; i++)
            {
                ...
                colors.Add(System.Windows.Media.Color.FromArgb(255, r, g, b));
            }

            // 투명 픽셀 처리
            while (colors.Count < 256) colors.Add(System.Windows.Media.Colors.Transparent);
            colors[255] = System.Windows.Media.Colors.Transparent;
            ...
            for (int i = 0; i < nActs; i++)
            {
                ...
                {
                    // 🌟 찾는 ID가 아니면, 해당 액션의 데이터(ms + 픽셀) 길이만큼 포인터를 건너뜁니다.
